...
export class FeatureReservedAreaCouponCreateComponent implements OnInit {
  ...
  saveCoupon() {
    ...
    // // const hours_from = this.couponForm.value.valid_from.substring(0, 2);
    // // const minutes_from = this.couponForm.value.valid_from.substring(3, 5);
    // console.log(this.couponForm.value.valid_from + ' this.couponForm.value.valid_from');
    ...
    console.log('stampa NaN:  ' + isValidDate(this.dateUntil));
    if (!isValidDate(this.dateUntil)) {
      this.dateUntil = new Date(0);

      // this.dateUntil = new Date( this.dateUntil.setDate(this.dateFrom.getDate() + 7300));
    }
    // const hours_until = this.couponForm.value.valid_until.substring(0, 2);
    // const minutes_until = this.couponForm.value.valid_until.substring(3, 5);
